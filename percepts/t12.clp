...
(ag_percept (percept_pobj case2) (percept_pname partof) (percept_pval ev12))
(ag_percept (percept_pobj curr_road) (percept_pname partof) (percept_pval ev12))
(ag_percept (percept_pobj road_to_left) (percept_pname partof) (percept_pval ev12))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev12))
(ag_percept (percept_pobj cross_walk1) (percept_pname partof) (percept_pval road_to_left))

(ag_percept (percept_pobj semaphore1) (percept_pname color) (percept_pval green))
(ag_percept (percept_pobj another_car) (percept_pname distance) (percept_pval 1000))
(ag_percept (percept_pobj my_car) (percept_pname position) (percept_pval lane2))
