...
(ag_percept (percept_pobj current_road) (percept_pname partof) (percept_pval ev1))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev1))
(ag_percept (percept_pobj another_car) (percept_pname partof) (percept_pval ev1))

(ag_percept (percept_pobj my_car) (percept_pname speed) (percept_pval 60))
(ag_percept (percept_pobj current_line) (percept_pname type) (percept_pval continuos))
