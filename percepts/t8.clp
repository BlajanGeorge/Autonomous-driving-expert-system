...
(ag_percept (percept_pobj road_sign_go_agead) (percept_pname isa) (percept_pval road_sign))
(ag_percept (percept_pobj case1) (percept_pname isa) (percept_pval case))

(ag_percept (percept_pobj current_road) (percept_pname partof) (percept_pval ev8))
(ag_percept (percept_pobj road_to_left) (percept_pname partof) (percept_pval ev8))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev8))
(ag_percept (percept_pobj another_car) (percept_pname partof) (percept_pval ev8))
(ag_percept (percept_pobj road_sign_go_agead) (percept_pname partof) (percept_pval current_road))
