...
(ag_percept (percept_pobj case2) (percept_pname partof) (percept_pval ev15))
(ag_percept (percept_pobj curr_road) (percept_pname partof) (percept_pval ev15))
(ag_percept (percept_pobj road_to_left) (percept_pname partof) (percept_pval ev15))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev15))
...
(ag_percept (percept_pobj another_car) (percept_pname distance) (percept_pval 1000))
(ag_percept (percept_pobj my_car) (percept_pname position) (percept_pval lane1))
(ag_percept (percept_pobj cross_walk1) (percept_pname people) (percept_pval yes))
(ag_percept (percept_pobj another_car) (percept_pname position) (percept_pval lane4))
(ag_percept (percept_pobj another_car) (percept_pname direction) (percept_pval V))