...
(ag_percept (percept_pobj case2) (percept_pname partof) (percept_pval ev16))
(ag_percept (percept_pobj curr_road) (percept_pname partof) (percept_pval ev16))
(ag_percept (percept_pobj road_to_left) (percept_pname partof) (percept_pval ev16))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev16))
...
(ag_percept (percept_pobj another_car) (percept_pname direction) (percept_pval S))