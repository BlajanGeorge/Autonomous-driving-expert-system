...
(ag_percept (percept_pobj current_road) (percept_pname partof) (percept_pval ev2))
...
(ag_percept (percept_pobj my_car) (percept_pname partof) (percept_pval ev2))
(ag_percept (percept_pobj another_car) (percept_pname partof) (percept_pval ev2))
